...
class CourtSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Court
        fields = [
            "id", "name", "sport_type", "description", "location",
            "price_per_hour", "capacity", "is_active", "images", "availabilities"
        ]

class CourtCreateUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Court
        fields = ["name", "sport_type", "description", "location", "price_per_hour", "capacity", "is_active"]
...
class CourtListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Court
        fields = [
            "id", "name", "sport_type", "city", "location",
            "price_per_hour", "capacity", "is_active", "first_image"
        ]
